...
<div id="wrap">
  ...
  <div class="form-raw">
      ...
      <div class="form-txtfld txtfld50"><input type="text" placeholder="heading" name="heading"></div>
       ...
       @endif
      <div class="form-txtfld txtfld50"><input type="text" placeholder="desciption" name="desciption"></div>
 ...
 <!--  <div class="form-raw">
  ...
  <div class="form-raw" style="width:100%;">
    ...
    <div class="form-txtfld" style="width:780px;">
      <textarea style="width:100%; height:500px;" name="content" id="body"></textarea>
    </div>
...
<div class="form-raw">
      <div class="form-name">&nbsp;</div>
      <div class="form-txtfld txtfld50"><input type="text" placeholder="PDF heading" name="pdf_heading"></div>
      @if ($errors->has('pdf_heading'))
      <span class="req-field">{{ $errors->first('pdf_heading') }}</span>
    @endif
      <div class="form-txtfld txtfld50"><input type="file" placeholder="desciption" name="pdf_file"></div>
...
<div id="wrap2">
   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="admintable">
    ...
    <tr>
      ...
      <td align="left" valign="top"><a href="{{route('product.edit',$p->id)}}">Edit</a></td>
